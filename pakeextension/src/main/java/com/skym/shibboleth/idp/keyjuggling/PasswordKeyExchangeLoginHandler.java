 ...
 */
public class PasswordKeyExchangeLoginHandler extends AbstractLoginHandler {

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(PasswordKeyExchangeLoginHandler.class);
     ...
     */
    public PasswordKeyExchangeLoginHandler(String servletPath) {
        super();
