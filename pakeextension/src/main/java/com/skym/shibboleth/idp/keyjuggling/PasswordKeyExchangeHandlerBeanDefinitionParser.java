 ...
 */
public class PasswordKeyExchangeHandlerBeanDefinitionParser extends AbstractLoginHandlerBeanDefinitionParser {

    /** Schema type. */
    public static final QName SCHEMA_TYPE = new QName(KeyJugglingHandlerNamespaceHandler.NAMESPACE, "PasswordKeyExchangeLogin");

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(PasswordKeyExchangeHandlerBeanDefinitionParser.class);

    /** {@inheritDoc} */
    protected Class getBeanClass(Element element) {
        return PasswordKeyExchangeHandlerFactoryBean.class;
    }
