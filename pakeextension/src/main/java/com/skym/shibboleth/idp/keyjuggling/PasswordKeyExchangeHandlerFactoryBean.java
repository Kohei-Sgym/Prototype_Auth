...
import com.skym.shibboleth.idp.keyjuggling.PasswordKeyExchangeLoginHandler;
import edu.internet2.middleware.shibboleth.idp.config.profile.authn.AbstractLoginHandlerFactoryBean;
/**
 * Factory bean for {@link PasswordKeyExchangeLoginHandler}s.
 */
public class PasswordKeyExchangeHandlerFactoryBean extends AbstractLoginHandlerFactoryBean {
    ...
    protected Object createInstance() throws Exception {
        PasswordKeyExchangeLoginHandler handler = new PasswordKeyExchangeLoginHandler(
    ...
    public Class getObjectType() {
        return PasswordKeyExchangeLoginHandler.class;
    }
}